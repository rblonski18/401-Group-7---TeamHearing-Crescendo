...
function clinic(settings) {
	...
	loadscript('main',() => {
		...
		if(typeof audio==='undefined'){
			if(true){
				layout.message('Audio','Permission to play audio?',{
					Okay:function(){
						...
						processor.snr(-24);
						processor.signal('data/musanim/video clips/piano_250_220_1_1.mp4');
						setTimeout(function(){ processor.snr(0); }, 3000);
			...
			} else { audio = new AudioContext(); processor = new Processor(); }
		}
	});
}
function Clinic(settings) {
